        ...
        <PrincipalDiv>
            ...
            <div style={{ width: "100%", display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
                <div style={{
                   ...
                   <div style={{ width: "50%", height: 400,display:'flex',  marginLeft:100}}>
                        <h1 style={{ textAlign: 'start', fontSize: 70, fontWeight: 600, marginTop:30 }}>
                ...
                <div style={{
                    width: '100%', display: 'flex', height: '580px',
